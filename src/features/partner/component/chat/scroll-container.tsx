...
export default function ScrollContainer({
  ...
  useEffect(() => {
    if (!ref.current || !autoScrollRef?.current) return;
  ...
  return (
    <div className="flex flex-1 w-full overflow-y-auto p-4 space-y-4 scrollbar-thin scrollbar-thumb-[#373A40] scrollbar-track-transparent relative">
      <div
        ref={ref}
        className={cn(
          "flex flex-col w-full lex-grow overflow-y-auto scrollbar-thin scrollbar-thumb-[#373A40] scrollbar-track-transparent",
          className
        )}
