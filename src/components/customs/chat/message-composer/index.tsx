...
import ConfigurationXModal from "../configuration-x-modal";
...
export default function MessageComposer({
  ...
  const onSubmit = useCallback(
    async (
      ...
      sendMessage(messageUser, fileReferences);
    },
  ...
  const onReply = useCallback(
    async (msg: string) => {
      ...
      replyMessage(messageUser);
      if (autoScrollRef) {
        autoScrollRef.current = true;
      }
    },
    [user, replyMessage, config]
  );
  ...
  return (
    ...
    >
      ...
      <Input
        ...
        placeholder={
          isReplies
            ? "Paste link of the Tweet here and make sure to use config to select amount of replies needed"
