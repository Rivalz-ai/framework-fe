...
import AutoResizeTextarea from "@/components/customs/auto-resize-textarea";
import { InlinedElements } from "./content/inlined-elements";
  ...
  return (
    <div className="flex flex-col w-full gap-1">
      ...
      <div className="flex flex-row items-center gap-1 w-full group">
        ...
        <div
          className={cn(
            "px-5 py-2.5 relative bg-accent rounded-[20px] ",
