      ...
      components={{
        ...
        code(props) {
          return (
            <code
              {...omit(props, ["node"])}
              className="relative rounded bg-muted px-[0.3rem] py-[0.2rem] font-mono text-sm font-semibold bg-black text-white"
            />
          );
        },
        ...
        strong(props) {
          return (
            <span {...omit(props, ["node"])} className="font-bold text-white" />
          );
        },
        hr() {
          return <Separator />;
        ...
        ul(props) {
          return (
            <ul
              {...omit(props, ["node"])}
              className="my-3 ml-3 list-disc pl-2 [&>li]:mt-1 text-white"
            />
          );
        },
        ol(props) {
          return (
            <ol
              {...omit(props, ["node"])}
              className="my-3 ml-3 list-decimal pl-2 [&>li]:mt-1 text-white"
            />
          );
        },
        h1(props) {
          return (
            <h1
              {...omit(props, ["node"])}
              className="scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl mt-8 first:mt-0 text-white"
            />
          );
        },
        h2(props) {
          return (
            <h2
              {...omit(props, ["node"])}
              className="scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight mt-8 first:mt-0 text-white"
            />
          );
        },
        h3(props) {
          return (
            <h3
              {...omit(props, ["node"])}
              className="scroll-m-20 text-2xl font-semibold tracking-tight mt-6 first:mt-0 text-white"
            />
          );
        },
        h4(props) {
          return (
            <h4
              {...omit(props, ["node"])}
              className="scroll-m-20 text-xl font-semibold tracking-tight mt-6 first:mt-0 text-white"
            />
          );
        },
        p(props) {
          return (
            <div
              {...omit(props, ["node"])}
              className="leading-7 [&:not(:first-child)]:mt-4 whitespace-pre-wrap break-words text-white"
              role="article"
            />
          );
        },
        table({ children, ...props }) {
          return (
            <Card className="[&:not(:first-child)]:mt-2 [&:not(:last-child)]:mb-2 text-white">
